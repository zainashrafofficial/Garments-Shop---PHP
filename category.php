...
<head>
	<meta charset="utf-8">
	<title> View Category | Garments Shop </title>
			...
			<div>
				...
				<?php
							if(isset($_GET['cat_name'])){
								echo '<h1 align="center">'.$_GET['cat_name'].'</h1>';
									echo '<div id="'.$_GET['subCat_name'].'">';
									echo '<div class="row" style="padding: 20px 0 20px 0;">';
									
									echo '<h3 class="subHeading">'.$_GET['subCat_name'].'</h3>';

									$myQuery2="select * from products where subCat_id=".$_GET['subCat_id'];
								...
								$myResult.='<a href="Details.php?pID='.$row2['product_id'].'"><img class="img-thumbnail" src="'.$row2['img_url'].'" alt="'.$row2['product_id'].'"></a>';
								 ...
								 echo $myResult;
									...
									echo "<h1 align='center' style='padding-top:20px'><small>Sorry...!!! <br> Please Select a Category...!!!!</small></h1>";
								}
