...
<head>
	...
	<meta content="description" name="Final Term Project (Online Garments Shop Project) by Zubair Ashraf submitted to Rana Saleem Sb :)">
	...
	<div class="container-fluid" align="center" style="margin-bottom: 20px">
				<div class="row">
					<div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3 wow rubberBand">
						<!--================Form============================-->
						<form action="userRegister_process.php" method="POST" role="form">
							<h2>Please Sign Up <small>It's free and always will be.</small></h2>
							<hr>
							<div class="row">
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
										<input type="text" name="fName" id="fName" minlength="4" maxlength="20" required class="form-control input-lg" placeholder="First Name">
									</div>
								</div>
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
										<input type="text" name="lName" id="lName" minlength="4" required maxlength="20" class="form-control input-lg" placeholder="Last Name">
									</div>
								</div>
							</div>
							<div class="form-group">
								<span id="error_email" style="float: right;"></span>
								<input type="email" name="email" id="email" maxlength="35" minlength="10" required class="form-control input-lg" placeholder="Email Address">

							</div>
							<div class="form-group">
								<input type="text" name="mobile" id="mobile" minlength="11" maxlength="14" required class="form-control input-lg" placeholder="Mobile Number">
							...
							<div class="row">
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
										<input type="password" name="password" minlength="4" maxlength="25" required id="password" class="form-control input-lg" placeholder="Password">
									</div>
								</div>
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
										<input type="password" name="cPassword" minlength="4" maxlength="25" required id="cPassword" class="form-control input-lg" placeholder="Confirm Password">
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-xs-2 col-sm-2 col-md-2" style="margin-right: 7%">
